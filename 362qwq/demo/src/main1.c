...
u16 o1_b2 = 80;
u16 o1_h1 = 260; //o1_h1 = obstacle1_height1
u16 o1_h2 = 280;
...
void hop(u16 hop_b1, u16 hop_h1, u16 hop_b2, u16 hop_h2) {
    if ((hop_b2 > base1) && (hop_b1 < base2) && (hop_h2 >= height1) && (hop_h1 <= height2)) {
       LCD_DrawFillRectangle(base1, height2, base2, height1, BROWN);
       base1 += 20;
       base2 += 20;
    }
...
void TIM7_IRQHandler(void) {
    TIM7->SR &= ~TIM_SR_UIF;
    LCD_DrawFillRectangle(rec1, tall1, rec2, tall2, BROWN);
    ...
    LCD_DrawFillRectangle(rec3, tall3, rec4, tall4, BROWN);
    ...
    LCD_DrawFillRectangle(rec5, tall5, rec6, tall6, BROWN);
    ...
    if (GPIOC -> IDR & GPIO_IDR_0) {
        ...
        if((base2 > 240) && (height2 >= 160)){
            ...
            if (height2 < 160) {
                ...
                if (x == 1) {
                    LCD_DrawFillRectangle(base1 - 20, height2, base1, height1, BROWN);
                }
            }
            else if (height2 >= 160) {
        ...
        if((base1 < 0) && (height2 >= 160)) {
            ...
            if (height2 < 160) {
                ...
                if (x == 1) {
                    LCD_DrawFillRectangle(base2, height2, base2+20, height1, BROWN);
                }
            }
            else if (height2 >= 160) {
                LCD_DrawFillRectangle(base2, height2, base2+20, height1, BLACK);
    ...
    if (GPIOC -> IDR & GPIO_IDR_3) {
         ...
         if(height1 <= 40){
             ...
             LCD_DrawFillRectangle(base1, height1, base2, height1 + 20, BLACK);
                 ...
                 if (x == 1) {
                     LCD_DrawFillRectangle(base1, height1, base2, height1 + 20, BROWN);
                 }
             }
         }
     }
         ...
         if(height2 >= 300){
             ...
             LCD_DrawFillRectangle(base1, height2 - 20, base2, height2, BLACK);
                 ...
                 if (x == 1) {
                     LCD_DrawFillRectangle(base1, height2 - 20, base2, height2, BROWN);
                 }
             }
         }
     }
...
int main(){
    ...
    LCD_DrawPicture(a,d, (const Picture *) &frog);
